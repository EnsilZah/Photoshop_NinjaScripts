...
/*	
	...
	{
		case "NinjaArmy":
			loadJSX("NS_NinjaArmy.jsx"); break;
			
		case "PlatelessExport":
			loadJSX(""); break;
...
function loadJSX(fileName) {
    var csInterface = new CSInterface();
    var extensionRoot = csInterface.getSystemPath(SystemPath.EXTENSION) + "/scripts/";
